...
console.log(littleArms.weight);

// What was the diet of a velociraptor?
console.log(longNails.diet);

// How long was a stegosaurus?
console.log(spikeBack.length);

// What time period did tyrannosaurus live in?
console.log(littleArms.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(littleArms.roar());
...
*/
const populationTotal =zooAnimals.map(item => item.population).reduce(function(total, amount) {
  return total + amount
});
